...
class $YouthUsersTable extends YouthUsers
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('org_i_d')) {
      context.handle(
        _orgIDMeta,
        orgID.isAcceptableOrUnknown(data['org_i_d']!, _orgIDMeta),
      );
    }
...
class YouthUser extends DataClass implements Insertable<YouthUser> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || orgID != null) {
      map['org_i_d'] = Variable<int>(orgID);
    }
...
class YouthUsersCompanion extends UpdateCompanion<YouthUser> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (orgID.present) {
      map['org_i_d'] = Variable<int>(orgID.value);
    }
...
class $EducBgsTable extends EducBgs with TableInfo<$EducBgsTable, EducBg> {
  ...
  EducBg map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return EducBg(
      ...
      yearGraduate: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class EducBg extends DataClass implements Insertable<EducBg> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || yearGraduate != null) {
  ...
  EducBgsCompanion toCompanion(bool nullToAbsent) {
    return EducBgsCompanion(
      ...
      yearGraduate:
          yearGraduate == null && nullToAbsent
              ? const Value.absent()
              : Value(yearGraduate),
      createdAt: Value(createdAt),
    );
  ...
  EducBg copyWith({
    ...
    yearGraduate: yearGraduate.present ? yearGraduate.value : this.yearGraduate,
    createdAt: createdAt ?? this.createdAt,
  );
