...
class Validate extends StatefulWidget {
  ...
  const Validate({super.key, required this.profiles});
  @override
...
class _ValidateState extends State<Validate> {
                      ...
                      onPressed: () async {
                        ...
                        if (_steps == 1 &&
                          ...
                          final exists = await db
                              .youthExistsIgnoreCaseExceptInVal(
                                youthUserID,
        ...
        children: [
          TextFormField(
            ...
            validator: (value) {
              ...
              if (fullNameExist) {
                return 'Youth already exist in new records.';
              }
              return null;
            },
          ),
          ...
          !fullNameExist
              ...
              : Center(
                child: Column(
                  ...
                  children: [
                    Text(
                      'Youth already existed in the New records!',
                      style: TextStyle(
                    ...
                    Text(
                      'Do you want to override on this data by new record\'s data \n and mark as validated?',
                      style: TextStyle(
                        color: const Color.fromARGB(255, 174, 0, 0),
                      ),
  ...
  List<Widget> stepTab() => [
    Column(
      ...
      children: [
        CircleAvatar(
          radius: 15,
          backgroundColor:
              _steps >= 1 ? Color.fromARGB(255, 2, 144, 140) : Colors.black12,
          child: Text(
            '1',
            style: TextStyle(
    ...
    Container(
      ...
      decoration: BoxDecoration(
        color:
            _steps > 1 ? Color.fromARGB(255, 2, 144, 140) : Colors.transparent,
    ...
    Column(
      ...
      children: [
        CircleAvatar(
          radius: 15,
          backgroundColor:
              _steps >= 2 ? Color.fromARGB(255, 2, 144, 140) : Colors.black12,
          child: Text(
            '2',
            style: TextStyle(
    ...
    Container(
      ...
      decoration: BoxDecoration(
        color:
            _steps > 2 ? Color.fromARGB(255, 2, 144, 140) : Colors.transparent,
        border: Border.all(color: Colors.black26, width: 1),
        borderRadius: BorderRadius.circular(25),
      ),
    ),
    ...
    Column(
      ...
      children: [
        CircleAvatar(
          radius: 15,
          backgroundColor:
              _steps >= 3 ? Color.fromARGB(255, 2, 144, 140) : Colors.black12,
          child: Text(
            '3',
            style: TextStyle(
    ...
    Container(
      ...
      decoration: BoxDecoration(
        color:
            _steps > 3 ? Color.fromARGB(255, 2, 144, 140) : Colors.transparent,
        border: Border.all(color: Colors.black26, width: 1),
        borderRadius: BorderRadius.circular(25),
      ),
    ),
    ...
    Column(
      ...
      children: [
        CircleAvatar(
          radius: 15,
          backgroundColor:
              _steps >= 4 ? Color.fromARGB(255, 2, 144, 140) : Colors.black12,
          child: Text(
            '4',
            style: TextStyle(
    ...
    Container(
      ...
      decoration: BoxDecoration(
        color:
            _steps > 4 ? Color.fromARGB(255, 2, 144, 140) : Colors.transparent,
        border: Border.all(color: Colors.black26, width: 1),
        borderRadius: BorderRadius.circular(25),
      ),
    ),
    ...
    Column(
      ...
      children: [
        CircleAvatar(
          radius: 15,
          backgroundColor:
              _steps >= 5 ? Color.fromARGB(255, 2, 144, 140) : Colors.black12,
          child: Text(
            '5',
            style: TextStyle(
